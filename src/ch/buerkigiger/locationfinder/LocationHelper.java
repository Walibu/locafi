        ...
        GooglePlayServicesClient.OnConnectionFailedListener, LocationListener
{
    ...
    // interface for updating the location, the receiver must implement this
    // method
        ...
        if (location != null)
        {
            ...
            if (accuracy < REQUIRED_ACCURACY_M)
            {
                ...
                Toast.makeText(mActivity,
                        mActivity.getText(R.string.position_reached) + accuracy.toString() + "m",
            ...
            else
            {
                ...
                Toast.makeText(mActivity,
                        mActivity.getText(R.string.position_updated) + accuracy.toString() + "m",
                        Toast.LENGTH_SHORT).show();
